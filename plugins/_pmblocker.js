...
export async function before(m, { conn, isAdmin, isBotAdmin, isOwner, isROwner }) {
    ...
    if (!m.isGroup) {
      ...
      if (bot.pmblocker && !isOwner && !isROwner) {
        ...
        await m.reply(`*Hello @${m.sender.split`@`[0]}, messaging the bot privately is currently disabled by 【𝐒𝐘𝐒𝐒𝐎𝐋𝐔𝐓𝐈𝐎𝐍𝐒 𝐁𝐎𝐓™】. You have been blocked from using the bot.*`, false, { mentions: [m.sender] });
